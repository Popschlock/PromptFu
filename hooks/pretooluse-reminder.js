...
process.stdin.on('end', () => {
  const context =
    ...
    'read the target-model profile (Fable 5 by default; Opus 4.8 for security or bio-flavored ' +
    'work; Sonnet 5 for well-specified building; Haiku 4.5 for mechanical work), state the intent, ' +
