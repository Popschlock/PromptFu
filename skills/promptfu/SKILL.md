...
|---|---|---|
| Anthropic | `models/anthropic/_family.md` | Opus 5.5 default. Fable 5.1 on named exceptions. Sonnet 5 execution, Haiku 4.5 mechanical. Opus 5 only when pinned |
